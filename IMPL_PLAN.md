...
Related (same pattern of observed-but-unenforced OS intent metadata): the M10 tsoFlags hardening TODO — txDrainOne gates TSO on segsz rather than the request flags.
